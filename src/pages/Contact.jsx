export default function Contact() {
  return (
    <div className="w-full bg-indigo-800 text-center  ">
      <div className="flex flex-col mx-4 md:mx-auto  py-20 justify-center items-center md:max-w-[730px]">
        <h3 className="text-white md:text-4xl font-bold text-3xl">
          Stay Updated with Educational Innovations
        </h3>
        <p className="text-gray-200 sm:px-[1em] md:px-[2.25em] mt-7 text-xl">
        ...
        <div className="w-[446px] px-1 sm:max-w-[446px] justify-center items-center mt-10 flex sm:flex-row flex-col">
          <input
        ...
        <ul className="mt-6 flex w-full justify-center gap-7 mb-4">
          <li className="mt-5 hover:text-indigo-400 transition duration-200">
            <a href="">
              <i className="fa-brands text-white text-xl fa-facebook text-[17px]"></i>
            </a>
          </li>
          <li className="mt-5 hover:text-indigo-400 transition duration-200">
            <a href="">
              <i className="fa-brands text-white text-xl fa-twitter"></i>
            </a>
          </li>
          <li className="mt-5 hover:text-indigo-400 transition duration-200">
            <a href="">
              <i className="fa-brands text-white text-xl fa-instagram fa-lg"></i>
            </a>
          </li>
          <li className="mt-5 hover:text-indigo-400 transition duration-200">
            <a href="">
              <i className="fa-brands text-white text-xl fa-youtube fa-lg"></i>
            </a>
          </li>
        </ul>
      </div>

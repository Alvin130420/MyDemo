    ...
    <div className='bg-gradient-to-br from-indigo-600 to-red-500 w-full md:pt-0 pt-16'>
      <div className="flex px-4 md:flex-row gap-y-10 flex-col items-center pt-20 min-h-screen mx-auto  container">
        <div className="relative md:w-3/6 md:text-start text-center ">
          <div className='fixed left-[310px] top-[150px]'><i className="fa-solid fa-circle text-[80px] text-white/10"></i></div>
          <div className='fixed left-[310px] top-[10px]'><i className="fa-solid fa-triangle text-[80px] text-white/10"></i></div>
          <i className="fa-solid fa-triangle text-[80px] text-white/10"></i>

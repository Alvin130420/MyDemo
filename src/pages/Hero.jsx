    ...
    <div className='bg-gradient-to-br from-indigo-600 to-red-500 w-full md:pt-0 pt-16'>
      <div className="flex px-4 md:flex-row gap-y-10 flex-col items-center pt-20 min-h-screen mx-auto  container">
        <div className="relative md:w-3/6 md:text-start text-center ">
          ...
          <h1 className='lg:text-[55px] md:text-[47px] text-[35px] md:w-96/100 font-[Poppins]  md:mx-0 mx-auto md:leading-12 lg:leading-16 text-white'>Revolutionize Your Learning Experience</h1>
          <p className='text-[20px] lg:w-5/6 md:mx-0 mx-auto md:mt-6 mt-3 text-white font-[Poppins] '>Elite Edu Tech transforms education with innovative technology solutions designed for today's students and educators.</p>

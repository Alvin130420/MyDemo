  ...
  return (
    <section className='about-wrapper min-h-screen pb-10'>
      ...
      <div className="about-cards grid grid-cols-1 md:grid-cols-4 gap-3">
        {cardData.map((data) => (
          <div className='group about-card md:w-70 rounded-xl shadow-lg border-1 border-gray-100 p-8 m-2 transition-all duration-300 hover:shadow-xl hover:border-indigo-600'>

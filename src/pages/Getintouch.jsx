...
function Getintouch(){
    return(
        <div className="bg-indigo-600 py-20">
            <h1 className="font-bold text-white text-3xl text-center">Get in Touch</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10">
                <div>
                    ...
                    <p className="text-2xl font-bold text-white mb-6 ">Contact Information </p>
                        <div className="flex">
                            <div className="h-6 w-6 text-indigo-400"> <MapPin /></div>
                        ...
                        <div className="flex">
                            <div className="h-6 w-6 text-indigo-400"> <Phone /></div>
                        ...
                        <div className="flex">
                            <div className="h-6 w-6 text-indigo-400"> <Mail /></div>
                        ...
                        <div className="flex">
                            <div className="h-6 w-6 text-indigo-400"> <Clock /></div>

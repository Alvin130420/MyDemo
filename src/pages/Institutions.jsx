...
function Institutions(){
   return(
    ...
    <h1 className="text-2xl  font-bold text-indigo-900 text-center mb-3">Trusted by Leading Institutions</h1>
    ...
    <div className=" grid grid-cols-1 gap-8 grid-cols-1 md:grid-cols-3 lg:grid-cols-6 ">
